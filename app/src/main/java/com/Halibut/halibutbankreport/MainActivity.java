...
public class MainActivity extends AppCompatActivity {
    ...
    String waveHigh;
    public String halibhutBank = "https://weather.gc.ca/marine/weatherConditions-currentConditions_e.html?mapID=02&siteID=14305&stationID=46146";
...
//////------------- Main Body
        ...
        spinnerDropBouy.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i){
                    case 0:
                        waveHigh = getCurrentDataFromHalibutBank(halibhutBank);
                        crossibilityStripOfGeorgeaStrait(waveHigh);
//                        waveHigh = getCurrentDataFromHalibutBank(halibhutBank);
//               CrossabilityStrip theStrip = new CrossabilityStrip();
//                theStrip.crossibilityStripOfGeorgeaStrait(waveHigh);
//                crossibilityStripOfGeorgeaStrait(waveHigh);
                        break;
